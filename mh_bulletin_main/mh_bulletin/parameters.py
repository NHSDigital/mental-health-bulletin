...
activity_higher_than_england_totals = [
  ...
  "Attendance Code; Service or Team Type", 
  "England; Intervention Type",
  "Provider; Intervention Type", "Commissioning Region; Intervention Type", "ICB of Residence; Intervention Type", "LAD/UA; Intervention Type",
  "Intervention Type; Gender", "Intervention Type; Age Group (Lower Level)", "Intervention Type; Gender; Age Group (Lower Level)"
]
...
test_output_columns = ["REPORTING_PERIOD_START", "REPORTING_PERIOD_END", "STATUS", "BREAKDOWN", "LEVEL_ONE", "LEVEL_ONE_DESCRIPTION", "LEVEL_TWO", "LEVEL_TWO_DESCRIPTION", "LEVEL_THREE", "LEVEL_THREE_DESCRIPTION", "LEVEL_FOUR", "LEVEL_FOUR_DESCRIPTION", "METRIC", "METRIC_NAME", "METRIC_VALUE"]