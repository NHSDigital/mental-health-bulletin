...
"5a": {
  ...
  "filter_clause": (F.col("StartDateHospProvSpell").between("2023-04-01", "2024-03-31")),
...
"5b": {
  ...
  "freq": "12M", 
  "source_table": "admissions_discharges",
  "filter_clause": (F.col("DischDateHospProvSpell").between("2023-04-01", "2024-03-31")),
  "aggregate_field": (F.expr("COUNT(DISTINCT UniqHospProvSpellID)").alias("METRIC_VALUE")),
  "aggregate_function": produce_filter_agg_df,
  "numerator_id": "5b",
  "denominator": 0,
...
"7d": {
  ...
  "related_to": "people",
  "suppression": "percent",
  "breakdowns": [eng_bd, upper_eth_bd, lower_eth_bd, age_band_common_bd, imd_decile_bd, upper_eth_age_band_lower_common_bd, gender_age_band_lower_common_bd, stp_res_bd, stp_res_age_band_common_bd, stp_res_upper_eth_bd, stp_res_gender_bd, stp_res_imd_decile_bd, ccg_prac_res_bd, ccg_prac_res_upper_eth_bd]
},
"7e": {
...
"11a": {
  ...
  "related_to": "people",
  "suppression": "count",
  "breakdowns": [age_band_higher_bd, age_band_chap11_bd, ccg_prac_res_bd, ccg_prac_res_age_band_higher_bd, ccg_prac_res_upper_eth_bd, ccg_prac_res_imd_quintile_bd, comm_region_bd, eng_bd, upper_eth_bd, upper_eth_age_band_lower_chap11_bd, lower_eth_bd, lower_eth_age_band_lower_chap11_bd, imd_decile_bd, imd_quintile_bd, imd_decile_age_band_lower_chap11_bd, prov_bd, prov_age_band_higher_bd, prov_upper_eth_bd, prov_imd_quintile_bd, stp_res_bd],
},
"11b": {
...
"15f": {
  "name": "Children and young people acute admissions in the RP aged 0 to 17",
  "freq": "12M", 
  "source_table": "cmh_agg",
...
"15g": {
  ...
  "15i": {
  "name": "Children and young people acute admissions with contact in the RP aged 0 to 17",
  "freq": "12M", 
  "source_table": "cmh_agg",
  "filter_clause": (F.col("AgeRepPeriodEnd").between(0, 17)),
  "aggregate_field": (F.expr("CAST(SUM(Contact) AS INT)").alias("METRIC_VALUE")),
 ...
 "15l": {
  "name": "Children and young people acute admissions with no contact in the RP aged 0 to 17",
  "freq": "12M", 
  "source_table": "cmh_agg",
  "filter_clause": (F.col("AgeRepPeriodEnd").between(0, 17)),
  "aggregate_field": (F.expr("CAST(SUM(NoContact) AS INT)").alias("METRIC_VALUE")),
...
"15o": {
  ...
  "15r": {
  "name": "Crude Rate of Children and young people acute admissions with contact in the RP aged 0 to 17 per 100,000 population",
  "freq": "12M", 
  "source_table": "cmh_agg",
  "filter_clause": (F.col("AgeRepPeriodEnd").between(0, 17)),
  "aggregate_field": (F.expr("(COALESCE(SUM(NUMERATOR_COUNT)/SUM(POPULATION_COUNT), 0))*100000").alias("METRIC_VALUE")),
  ...
  "15u": {
  "name": "Crude Rate of Children and young people acute admissions with no contact in the RP aged 0 to 17 per 100,000 population",
  "freq": "12M", 
  "source_table": "cmh_agg",
  "filter_clause": (F.col("AgeRepPeriodEnd").between(0, 17)),
  "aggregate_field": (F.expr("(COALESCE(SUM(NUMERATOR_COUNT)/SUM(POPULATION_COUNT), 0))*100000").alias("METRIC_VALUE")),
...
"17a": {  
  ...
  "related_to": "people",
  "suppression": "count",
  "breakdowns": [age_band_chap1_bd, ccg_res_bd, ccg_res_age_band_chap1_bd, ccg_res_upper_eth_bd, ccg_res_lower_eth_bd, ccg_res_gender_bd, ccg_res_imd_decile_bd, comm_region_bd, comm_region_age_band_chap1_bd, comm_region_upper_eth_bd, comm_region_lower_eth_bd, comm_region_gender_bd, comm_region_imd_decile_bd, eng_bd, upper_eth_bd, upper_eth_age_band_lower_chap1_bd, lower_eth_bd, lower_eth_age_band_lower_chap1_bd, gender_bd, gender_age_band_lower_chap1_bd, imd_decile_bd, imd_quintile_bd, imd_decile_age_band_lower_chap1_bd, prov_bd, prov_age_band_chap1_bd, prov_upper_eth_bd, prov_lower_eth_bd, prov_gender_bd, prov_imd_decile_bd, stp_res_bd, stp_res_age_band_chap1_bd, stp_res_upper_eth_bd, stp_res_lower_eth_bd, stp_res_gender_bd, stp_res_imd_decile_bd, la_bd], 
},
"17b": {
...
automated_metric_metadata = {
  ...
  "CUSTOM_RUN": {**ch10_measure_ids, **ch11_measure_ids, **ch16_measure_ids},
  "CUSTOM_RUN_AW": {**ch11_measure_ids, **ch18_measure_ids}
}
