...
# COMMAND ----------
 ...
 LEFT  JOIN global_temp.Bed b 
            ...
            AND b.BedRN = 1
 -- LEFT  JOIN $db_output.MPI_PROV m ---Hosp has already been joined to MPI table so thought was unessecary, relevant demographic breakdowns get added in later using MPI_PROV
 --            ON m.Person_ID = h.Person_ID 
 --            AND m.RecordNumber = h.RecordNumber
...
# COMMAND ----------
 ...
 --        age_group_lower_chap12,
        ...
        IMD_Quintile,
        IMD_Decile,
        LADistrictAuthCode as LADistrictAuth,
        LADistrictAuthName,
        f.ElgibleDischFlag,
