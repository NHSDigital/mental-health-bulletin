...
test_null_values(chap1_df, ["age_group_higher_level", "age_group_lower_chap1", "Bed_Type", "UpperEthnicity", "LowerEthnicityName", "Der_Gender", "IMD_Decile", "IMD_Quintile", "ServTeamTypeRefToMH", "ProvTypeCode"])
...
test_null_values(chap6_df, ["ProvTypeCode", "ServTeamTypeRefToMH"])
