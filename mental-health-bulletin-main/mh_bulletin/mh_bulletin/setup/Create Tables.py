...
# dbutils.widgets.text("populationyear", "2020")
# dbutils.widgets.text("IMD_year", "2019")
...
# COMMAND ----------
 ...
 age_group_lower_common string,
 age_group_lower_chap1 string,
 age_group_lower_chap45 string,
 age_group_lower_chap10 string,
 age_group_lower_chap10a string, 
 age_group_lower_chap11 string,
 age_group_lower_imd string
 ) USING DELTA
...
# COMMAND ----------
 ...
 %sql
 DROP TABLE IF EXISTS $db_output.RestrictiveIntTypeDim;
...
# COMMAND ----------
 ...
 HigherMHAdmittedPatientClassName string
 ) USING DELTA

# COMMAND ----------

 %sql
 DROP TABLE IF EXISTS $db_output.prov_type_desc;
 CREATE TABLE IF NOT EXISTS $db_output.prov_type_desc
 (
 ProvTypeCode string,
 ProvTypeName string
 ) USING DELTA
